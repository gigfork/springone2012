...
public class ContactsGenerator {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext("classpath:META-INF/spring/contacts-jpa/applicationContext*.xml");
		...
		for (long i = 1; i <= NUM_CONTACTS; i++) {
			...
			Address billingAddress = new Address("123 " + firstname + " " + lastname + " Street",null, "City","State","Country","12345");
			Address shippingAddress = new Address("345 " + firstname + " " + lastname + " Street",null, "City","State","Country","34567");
