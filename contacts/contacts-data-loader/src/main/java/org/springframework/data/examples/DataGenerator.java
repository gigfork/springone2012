...
public class DataGenerator {
	...
	public DataGenerator(String[] firstNames, String[] lastNames,
			String[] emailDomains) {
	...
	public EmailAddress companyEmailAddress(String firstName, String lastName,
			String companyName) {
	...
	public Phone getRandomPhone() {
		...
		String phoneNumber = StringUtils.arrayToDelimitedString(new Object[] {
				countryCode, areaCode, prefix, number }, "-");

		Phone.Type[] phoneTypes = new Phone.Type[] { Phone.Type.FAX,
				Phone.Type.MOBILE, Phone.Type.OFFICE, Phone.Type.HOME };
